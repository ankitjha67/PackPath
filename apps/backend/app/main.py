...
def create_app() -> FastAPI:
    ...
    # Never pair wildcard origins with credentials. With an empty allowlist no
    # cross-origin browser request is permitted; configure CORS_ORIGINS to an
    # explicit list to enable one.
    app.add_middleware(
        CORSMiddleware,
